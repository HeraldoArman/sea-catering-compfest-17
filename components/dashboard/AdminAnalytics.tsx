            ...
            <CardBody className="p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <Chip
                  ...
                  variant="flat"
                  startContent={React.createElement(getChangeIcon(analytics.mrr.change), {
                    className: "w-3 h-3",
                  })}
                  size="sm"
                >
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-1">{formatPrice(analytics.mrr.current)}</h3>
          ...
          <Card className="shadow-lg border-0 hover:shadow-xl transition-all duration-300">
            <CardBody className="p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <Chip color="success" variant="flat" startContent={<ArrowUp className="w-3 h-3" />} size="sm">
                  New
                </Chip>
              </div>
          ...
          <Card className="shadow-lg border-0 hover:shadow-xl transition-all duration-300">
            <CardBody className="p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <Chip color="warning" variant="flat" startContent={<RefreshCw className="w-3 h-3" />} size="sm">
                  Renewed
                </Chip>
              </div>
              <h3 className="text-2xl font-bold text-gray-900 mb-1">
            ...
            <CardBody className="p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <Chip
                  ...
                  variant="flat"
                  startContent={React.createElement(getChangeIcon(analytics.users.change), {
                    className: "w-3 h-3",
                  })}
                  size="sm"
                >
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-1">{formatNumber(analytics.users.total)}</h3>
            ...
            <CardBody className="p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <Chip
                  ...
                  variant="flat"
                  startContent={React.createElement(getChangeIcon(analytics.subscriptions.growth), {
                    className: "w-3 h-3",
                  })}
                  size="sm"
                >
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-1">{formatNumber(analytics.subscriptions.active)}</h3>
          ...
          <Card className="shadow-lg border-0 hover:shadow-xl transition-all duration-300">
            <CardBody className="p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <Chip color="success" variant="flat" startContent={<Plus className="w-3 h-3" />} size="sm">
                  New
                </Chip>
              </div>
              <h3 className="text-2xl font-bold text-gray-900 mb-1">{formatNumber(analytics.users.new)}</h3>
        ...
        <Card className="shadow-lg border-0 bg-gradient-to-r from-blue-50 to-purple-50">
          <CardBody className="p-6">
            <div className="text-center">
              <h3 className="text-lg font-bold text-gray-900 mb-2">Period Summary</h3>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                ...
                <div>
                  <div className="font-semibold text-green-600">{formatPrice(analytics.mrr.current)}</div>
                ...
                <div>
                  <div className="font-semibold text-purple-600">{(analytics.subscriptions.growth ?? 0).toFixed(1)}%
                  </div>
